...
export const BUILTIN_SKILLS: Skill[] = [
  {
    ...
    tools: ["canvas"],
    instructions:
      "You are a world-class writing partner. Help with tone, structure, and edits. Prefer opening a canvas for anything longer than a few paragraphs.",
  },
  {
    id: "skill-coding",
    slug: "coding",
  ...
  },
  {
    ...
    tools: ["python", "canvas"],
    instructions:
      "You are a data analyst. Use python for calculations and charts. Explain findings clearly with tables and takeaways.",
  },
  {
    id: "skill-research",
    slug: "research",
